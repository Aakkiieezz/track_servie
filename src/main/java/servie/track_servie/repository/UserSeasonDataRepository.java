...
{
        @Query(value = "SELECT new servie.track_servie.payload.dtos.operationsServiePageDtos.SeasonDtoServiePage(season.id, season.name, season.seasonNumber,"
                        ...
                        +" LEFT JOIN UserSeasonData AS userSeasonData ON userSeasonData.seasonNumber = season.seasonNumber AND userSeasonData.userServieData.servie.tmdbId = season.series.tmdbId AND userSeasonData.userServieData.user = :user"
        ...
        @Query(value = "SELECT userSeasonData.seasonNumber"
